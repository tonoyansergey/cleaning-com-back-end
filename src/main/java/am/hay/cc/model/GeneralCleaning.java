...
@Document(collection = "general_cleaning")
public class GeneralCleaning {
    ...
    public GeneralCleaning(final String id, final String title, final String description, final Map<String, List<String>> services, final List<BaseCleaning> baseCleanings) {
        this.id = id;
        this.title = title;
