...
@Document(collection = "maintain_cleaning")
public class MaintainCleaning {
    ...
    public MaintainCleaning(final String id, final String title, final String description, final Map<String, List<String>> services, final List<BaseCleaning> baseCleanings) {
        this.id = id;
        this.title = title;
